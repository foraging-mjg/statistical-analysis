...
p1=ggplot(data=d1, aes(x=st, y=mean_ntrees_per_stage, group=rr, pch=rr, fill=rr)
) +
...
p4=ggplot(data=d4, aes(y=mu.dist, x=st, group=rr, pch=rr, fill=rr)) +
  facet_wrap(~ll) +
...
#ggsave(filename="e1-99-master-plot.svg", plot=pp, device="svg", width=9, height=12)
