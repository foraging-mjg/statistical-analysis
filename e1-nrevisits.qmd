...
The effect of fruit after Greenhouse-Geisser correction for sphericity violation was 
...
The fruit x resources interaction after Greenhouse-Geisser correction for sphericity violation was 
...
ggplot(data=pre.means, aes(y=mean.nrv, x=fr))+
  ...
  labs(title="Revisits", subtitle="Mean plus / minus one sd")+ theme_bw()
```
